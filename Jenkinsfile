pipeline {
    ...
    stages {
        ...
        stage('Build') {
          ...
          stage('Deploy') {
            steps {
                sh "mvn deploy -DskipTests -DaltDeploymentRepository=deploymentRepo::default::http://192.168.33.10:8081/repository/maven-releases/ -Dusername=admin -Dpassword=nexus"
            }
        }
      /*  
